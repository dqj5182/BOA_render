...
from utils.smpl import get_smpl_faces
...
class Renderer:
    def __init__(self, resolution=(224,224), orig_img=False, wireframe=False):
        ...
        # set the scene
        self.scene = pyrender.Scene(bg_color=[0.0, 0.0, 0.0, 0.0], ambient_light=(0.2, 0.2, 0.2))

        #light = pyrender.PointLight(color=[1.0, 1.0, 1.0], intensity=1)
        light = pyrender.DirectionalLight(color=[1.0, 1.0, 1.0], intensity=0.65)
